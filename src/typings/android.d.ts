			...
			export module android {
				export class ImageLoaderIF {
					...
					public constructor(implementation: {
						...
						getThresHoldValue(param0: native.Array<native.Array<number>>): number;
						imageLoad(param0: string): native.Array<native.Array<number>>;
					});
					public constructor();
					public getThresHoldValue(): number;
					public getThresHoldValue(param0: native.Array<native.Array<number>>): number;
		...
		export module port {
			export module android {
				export class DeviceConnection {
					...
					public constructor(implementation: {
						close(): void;
						getQueue(): com.sewoo.jpos.request.RequestQueue;
						read(param0: native.Array<number>): number;
						readData(param0: native.Array<number>): number;
						setDevTimeout(param0: number): void;
					});
					public constructor();
